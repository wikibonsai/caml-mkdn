...
export const camlUnprefixedListCommaCases: CamlTestCase[] = [
  ...
  // multi-line strings are not supported in comma-separated lists.
  // indicators (>, |, etc.) are treated as literal string values.
  {
    descr: 'unprefixed; list; comma-separated; string; multi-line; not supported (indicator treated as literal)',
    ...
    html: '<aside class="attrbox">\n'
        ...
        + '<dd><span class="attr string">></span></dd>\n'
        + '</div>\n'
        + '</dl>\n'
        + '</aside>\n',
    data: {
      ...
      parse: {
        'attribute': [
          { type: 'string', string: 'first', value: 'first' },
