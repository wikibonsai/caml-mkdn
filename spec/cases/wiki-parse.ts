...
export const camlWikiParseCases: CamlTestCase[] = [
  {
    ...
    html: '<aside class="attrbox">\n'
        ...
        + '<div class="attr-item">\n'
        + '<dt>attribute</dt>\n'
        + '<dd><a class="attr wiki reftype__attribute" href="/fname-a" data-href="/fname-a">fname-a</a></dd>\n'
        + '</div>\n'
        + '</dl>\n'
        + '</aside>\n',
    data: {
  ...
  },
  {
    ...
    html: '<aside class="attrbox">\n'
        ...
        + '<dt>attribute</dt>\n'
        + '<dd><a class="attr wiki reftype__attribute" href="/fname-a" data-href="/fname-a">fname-a</a></dd>\n'
        + '<dd><a class="attr wiki reftype__attribute" href="/fname-b" data-href="/fname-b">fname-b</a></dd>\n'
        + '</div>\n'
        + '</dl>\n'
        + '</aside>\n',
    data: {
