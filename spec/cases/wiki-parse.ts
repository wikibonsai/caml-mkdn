/*
 * wiki-parse: caml PARSES wiki values (`{ wikirefs: true }`). `[[x]]` becomes a 'wiki'-typed
 * value (brackets stripped, value 'fname-a'). This is the caml *parse* axis (parse); caml-mkdn
 * asserts only the parse/value `data`. The `html` field shows the ILLUSTRATIVE link shape a
 * sibling wikirefs plugin would render ("with wikirefs") — authoritative link rendering lives
 * in wikirefs-spec / each parser's render-w-wiki suite.
 */
import type { CamlTestCase } from '../types';
export const camlWikiParseCases: CamlTestCase[] = [
  {
    ...
    html: '<aside class="attrbox">\n'
        ...
        + '<dd><a class="attr wiki" href="/fname-a" data-href="/fname-a">fname-a</a></dd>\n'
        + '</div>\n'
        + '</dl>\n'
        + '</aside>\n',
    data: {
  ...
  },
  {
    ...
    html: '<aside class="attrbox">\n'
        ...
        + '<div class="attr-item">\n'
        + '<dt class="key__attribute">attribute</dt>\n'
        + '<dd><span class="attr string">[[invalid</span></dd>\n'
        + '</div>\n'
        + '</dl>\n'
        + '</aside>\n',
    data: {
  ...
  },
  {
    ...
    html: '<aside class="attrbox">\n'
        ...
        + '<dt class="key__attribute">attribute</dt>\n'
        + '<dd><a class="attr wiki" href="/fname-a" data-href="/fname-a">fname-a</a></dd>\n'
        + '<dd><a class="attr wiki" href="/fname-b" data-href="/fname-b">fname-b</a></dd>\n'
        + '</div>\n'
        + '</dl>\n'
        + '</aside>\n',
    data: {
  ...
  },
  {
    ...
    html: '<aside class="attrbox">\n'
        ...
        + '<dt class="key__attribute">attribute</dt>\n'
        + '<dd><a class="attr wiki" href="/fname-a" data-href="/fname-a">fname-a</a></dd>\n'
        + '<dd><span class="attr string">hello</span></dd>\n'
        + '</div>\n'
        + '</dl>\n'
        + '</aside>\n',
    data: {
  ...
  },
  {
    ...
    html: '<aside class="attrbox">\n'
        ...
        + '<dt class="key__attribute">attribute</dt>\n'
        + '<dd><a class="attr wiki" href="/fname-a" data-href="/fname-a">fname-a</a></dd>\n'
        + '<dd><span class="attr float">1.5</span></dd>\n'
        + '</div>\n'
        + '</dl>\n'
        + '</aside>\n',
    data: {
  ...
  },
  {
    ...
    data: {
      ...
      "value": {
        "attribute": [
          'fname-a',
          new Date('2001-12-14T00:00:00.000Z'),
        ],
      },
      "parse": {
        "attribute": [
          ...
          },
          {
            "type": 'time',
            "string": '2001-12-14',
            "value": new Date('2001-12-14T00:00:00.000Z'),
          },
        ],
      },
    },
