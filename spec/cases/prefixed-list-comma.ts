...
export const camlPrefixedListCommaCases: CamlTestCase[] = [
  ...
  // folded style (>)
  {
    descr: 'prefixed; list; comma-separated; string; multi-line; folded (>); basic',
  ...
  {
    descr: 'prefixed; list; comma-separated; string; multi-line; folded (>); with trailing newline',
    mkdn: ':attribute::first, >\n'
          + '  line one\n'
          + '  line two\n'
          + '\n',
  ...
  // literal style (|)
  {
    descr: 'prefixed; list; comma-separated; string; multi-line; literal (|); basic',
    mkdn: ':attribute::first, |\n'
          + '  line one\n'
          + '  line two\n',
    html: '<aside class="attrbox">\n'
  ...
  // chomped folded (>-)
  {
    descr: 'prefixed; list; comma-separated; string; multi-line; folded chomped (>-); strips trailing newlines',
    mkdn: ':attribute::first, >-\n'
          + '  line one\n'
          + '  line two\n'
          + '\n',
  ...
  // literal strip (|-)
  {
    descr: 'prefixed; list; comma-separated; string; multi-line; literal strip (|-); strips trailing newlines',
    mkdn: ':attribute::first, |-\n'
          + '  line one\n'
          + '  line two\n'
          + '\n',
  ...
  // literal keep (|+)
  {
    descr: 'prefixed; list; comma-separated; string; multi-line; literal keep (|+); preserves trailing newlines',
    mkdn: ':attribute::first, |+\n'
          + '  line one\n'
          + '  line two\n'
          + '\n',
  ...
  // folded keep (>+)
  {
    descr: 'prefixed; list; comma-separated; string; multi-line; folded keep (>+); preserves trailing newlines',
    mkdn: ':attribute::first, >+\n'
          + '  line one\n'
          + '  line two\n'
          + '\n',
  ...
  // edge cases
  {
    descr: 'prefixed; list; comma-separated; string; multi-line; folded (>); empty block',
    mkdn: ':attribute::first, >\n'
          + '\n',
    html: '<aside class="attrbox">\n'
        + '<span class="attrbox-title">Attributes</span>\n'
